...
<div class="topnav" id="myTopnav">
  ...
  <center><h3 class="heading"> TRAVEL BAGS </h3></center>
<div class="container">
     ...
     <?php
         ...
         if(mysqli_num_rows($select_product)>0){
             while($fetch_product = mysqli_fetch_assoc($select_product)){
               if($fetch_product['category']=='travel'){
 ?>
  ...
  <form method="post" class="box" action="shopping_cart.php">
      ...
      <input type="hidden" name="prod_image" value="<?php echo $fetch_product['image'];?>">
        ...
        <button><a href="product_details.php?id=<?php echo $fetch_product['p_id'];?>" class="btn" style="text-decoration:none; padding: 10px;"> View Details </a></button>
  </form>
   <?php
   };
             };
